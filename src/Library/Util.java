...
public class Util {
    ...
    // finds the frequency of char from string str and returns it
    ...
    // finds and returns the max number from in array
    ...
    // finds and returns the max number from array Wrapper
    ...
    // finds and returns the max number from double array Wrapper
    ...
    // finds and returns the min number from in array
    ...
    // find and returns the min number from int array Wrapper
    ...
    // find and returns the min number from double array Wrapper
